...
class CNN_Text(nn.Module):
    ...
    def __init__(self, args, embedding_weight, output_size, bert=None, itos=None):
        ...
        self.convs1 = nn.ModuleList([nn.Conv2d(Ci, args.kernel_num, (kernel_size, embedding_size))
    ...
    def forward(self, x, x_id):
        x = self.do_embedding(x, x_id)  # (N, W, D)
