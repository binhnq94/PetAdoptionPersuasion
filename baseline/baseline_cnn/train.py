import torch
from baseline.baseline_bilstm.load_data import load_data
...
def main(args):
    ...
    ID, TEXT, LABEL, vocab_size, word_embeddings, \
    ...
    model = CNN_Text(args, word_embeddings, output_size, bert=args.use_bert)
